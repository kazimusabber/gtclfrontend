...
import Featureimage2 from "../assets/img/icon/ideaone.png";
import Featureimage3 from "../assets/img/icon/coversationone.png";
import Featureimage4 from "../assets/img/icon/emergencyone.png";
...
import admissionImage from "../assets/img/icon/admission.png";
import assesmentImage from "../assets/img/icon/assessment.png";
import placementImage from "../assets/img/icon/placement.png";
import testImage from "../assets/img/icon/test.png";
import trainingImage from "../assets/img/icon/training.png";
    ...
    content: [
      {
        ...
        desc: `Skills training is designed to provide employees with the targeted training they need to gain the knowledge and abilities necessary to fulfill the specific requirements of their job positions. Skills training can also be used to re-educate and retrain employees whenever new technology, processes or systems debut.`,
        imageLink: `${Featureimage2}`,
      },
      {
        title: "Skill Test",
        desc: `A skills test is an assessment used to provide an unbiased, validated evaluation of a candidate's ability to perform the duties listed in the job description. Typically, a skills test asks a variety of questions in different formats to see how candidates perform on-the-job tasks.`,
        imageLink: `${Featureimage3}`,
      },
      {
        title: "Skill Assesment",
        desc: `Skill assessment is the comparison of actual performance of a skill with the specified standard for performance of that skill under the circumstances specified by the standard, and evaluation of whether the performance meets or exceed the requirements.`,
    ...
    content: [
      {
        ...
        imageLink: `${assesmentImage}`,
      },
      {
        title: "Admission",
        subtitle: "country & collage",
        imageLink: `${admissionImage}`,
      },
      {
        title: "Training",
        subtitle: "country & collage",
        imageLink: `${trainingImage}`,
      },
      {
        title: "Test",
        subtitle: "country & collage",
...
export const Instructors_data = [
  {
    ...
    subtitle: "Step forward to your abroad dream with us",
    content: [
      {
        imageLink: `${Teamposter2}`,
        title: "Arlene McCoy",
